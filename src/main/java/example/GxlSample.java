 ...
 */
public class GxlSample extends ChaincodeBase {
    private static String tableName = "GxlSample";
    private static Log log = LogFactory.getLog(GxlSample.class);
